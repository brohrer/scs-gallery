...
kEffNet-B0 with
639,702 parameters
got 91.64% accuracy on CIFAR-10
"""
import os
import sys
import time
...
n_units_3 = 320
n_params = (
    n_input_channels * n_units_1 * 9 +
    n_units_1 * n_units_2 *  9 +
    n_units_2 * n_units_3 *  9 +
    n_units_3 * 4 * 4 +
    n_units_1 +
    n_units_2 +
    n_units_3 +
    3)
print(f"{n_params} parameters in the model")
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.scs1 = SharpenedCosineSimilarity(
            in_channels=n_input_channels, out_channels=n_units_1, kernel_size=3, padding=0)
